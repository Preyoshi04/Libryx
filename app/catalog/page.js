      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
          <div className="relative w-full md:w-64 group">
            <SearchCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-blue-600 transition-colors" size={16} />
            <input 
              type="text"
              placeholder="Search..."
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <div className="p-1 rounded-full bg-secondary">
                        <Pen size={15} className="text-blue-600/70 dark:text-slate-400" /> 
                      </div>
      ...
      {books.length > 0 && processedBooks.length === 0 && (
        <div className="text-center py-20 bg-secondary/10 rounded-[2.5rem] border border-dashed border-border mt-10">
           <p className="text-muted-foreground text-lg italic tracking-tight">
            No books match "<span className="font-bold text-foreground">{searchQuery}</span>"
           </p>
        </div>
      )}
